...
describe UserGame do
  before do
    ...
    @game = Game.create(name: "Capture the Flag XIV", lat: 51.01245, lng: 42.16462, description: "Flagging", creator_id: @bob.id, start_time: "2022-10-14 11:23:00", end_time: "2022-10-14 11:23:00")
  end
  ...
  context 'creating a UserGame' do
    context 'with invalid criteria' do
      ...
      it 'should not be valid when the game is in the past' do
